    ...
    <AnimatePresence>
      {productos.length > 0 && (
        <motion.div
          ...
          className="sticky bottom-0 z-10 flex items-center justify-between gap-4 border-t border-borde bg-superficie px-5 py-3 shadow-[0_-4px_12px_var(--sombra)]"
        >
          ...
          <Link
            href="/"
            className="rounded-xl bg-acento px-4 py-2 text-sm font-medium text-sobre-acento transition hover:bg-acento-hover"
          >
