...
Pendiente de esta fase: 5.2 completa; de 5.3 la decisión de negocio escrita para los 13 flags listados en `registro-flags.md` (requiere al dueño del producto, no es una tarea de código); y de 5.4 los cuatro casos restantes (fal.ai sin saldo, idempotencia inalcanzable, y el arnés de inyección de fallos para proveedores pagados).
