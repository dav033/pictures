...
| 8.4 | Embeddings online de consulta vía Python | Migra `RETRIEVAL_QUERY` detrás de flag, manteniendo rollback léxico | No cambia la whitelist comercial ni permite que Python autorice productos |
