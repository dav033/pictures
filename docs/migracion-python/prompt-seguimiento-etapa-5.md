...
`C:\Users\davidt\Downloads\demo-decoracion\scripts\migrations\020_operational_idempotency.sql`

Migración del backend:

`C:\Users\davidt\Downloads\workspace\demo-decoracion-api\migrations\020_operational_idempotency.sql`
...
4. La extracción no incluía migración ni `.gitignore`.
   ...
   Ahora el repo backend incluye `migrations/020_operational_idempotency.sql`,
