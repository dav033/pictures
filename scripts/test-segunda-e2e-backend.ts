...
async function main(): Promise<void> {
  ...
  assert.match(construirSistema({ ragEnabled: true, franjasEnabled: false, planEnabled: true }), /CAMBIOS DEL CLIENTE[\s\S]*Nunca digas que cambiaste/);
  ...
  assert.match(construirSistema({ ragEnabled: true, franjasEnabled: false, planEnabled: true }), /NÚMEROS:[\s\S]*un globo número 4 y un globo número 0/);
  ...
  assert.match(construirSistema({ ragEnabled: true, franjasEnabled: false, planEnabled: true }), /NOMBRES PROTEGIDOS/);
