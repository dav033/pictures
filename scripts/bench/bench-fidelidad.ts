...
import { generar, payloadDe, resolverIdentidadLora, saldo, leerEnv } from "../lora/exp-fal-lib";
import { prepararEspacio } from "./espacio";
import { coloresDeEscena, compilarCaption, construirEscena, estructurasDeEscena, repartirColores } from "./escena";
...
import type { CasoBenchmark, Corrida, FaseBenchmark, PistaColocacion, PistaColor } from "./tipos";
 ...
 *
 *   npx tsx --conditions=react-server --env-file=.env.local scripts/bench/bench-fidelidad.ts --dry-run
 *   npx tsx --conditions=react-server --env-file=.env.local scripts/bench/bench-fidelidad.ts --fase fase-0-linea-base --espacio "C:/ruta/espacio.jpg" --confirm-spend --max-usd 1.00
 */
