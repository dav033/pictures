...
// tamaño dice cada caption (eso ya lo audita scripts/dataset/auditar-tamanos-captions.ts y dio 0
...
//
// Uso: npx tsx scripts/dataset/canonicalizar-tamanos-captions.ts [--aplicar] [--detalle]
