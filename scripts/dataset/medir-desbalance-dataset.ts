 ...
 *
 *   npx tsx --conditions=react-server scripts/dataset/medir-desbalance-dataset.ts
 *   npx tsx --conditions=react-server scripts/dataset/medir-desbalance-dataset.ts --anotaciones <dir>
 *
