...
// que ya usaba scripts/dataset/package-fal-final-dataset.py para el dataset de producto.
//
...
//
// Uso:
//   npx tsx scripts/dataset/exportar-dataset-fal.ts --trigger=eventdecor_style_v2
//   npx tsx scripts/dataset/exportar-dataset-fal.ts --categoria=general --dry-run
