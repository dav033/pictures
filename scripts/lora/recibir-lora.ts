 ...
 *
 *   NODE_OPTIONS=--use-system-ca npx tsx scripts/lora/recibir-lora.ts \
...
async function main(): Promise<void> {
  ...
  console.log(`  npx tsx scripts/lora/eval-lora-nuevo.ts --lora "${url}" --etiqueta ${etiqueta}`);
  console.log(`  npx tsx scripts/lora/exp-contacto.ts --dir reports/lora-debug/eval-${etiqueta} --patron scale08 --cols 3\n`);
