 ...
 *
 * Correr:
 *   NODE_OPTIONS=--use-system-ca npx tsx scripts/lora/recaption-v004.ts --muestra 6
 *   NODE_OPTIONS=--use-system-ca npx tsx scripts/lora/recaption-v004.ts        # las 154
 *
 ...
 *   NODE_OPTIONS=--use-system-ca npx tsx scripts/lora/recaption-v004.ts --raiz data/staging/recaption-v005 --solo-pendientes
 */
