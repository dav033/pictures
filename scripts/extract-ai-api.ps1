...
$migrationSource = Join-Path $repoRoot "scripts\migrations\019_operational_idempotency.sql"
$migrationTarget = Join-Path $targetMigrations "019_operational_idempotency.sql"
