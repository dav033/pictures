 ...
 *
 *   npx tsx scripts/eval/eval-variedad-composicion.ts --fixtures
 *   npx tsx scripts/eval/eval-variedad-composicion.ts --replay reports/variedad-composicion/corpus.json
 */
