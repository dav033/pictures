...
async function main(): Promise<void> {
  const migration = readFileSync("services/ai-api/migrations/001_operational_schema.sql", "utf8");
  assert.match(migration, /CREATE TABLE IF NOT EXISTS operational\.operational_idempotency/);
  ...
  assert.match(migration, /CREATE TABLE IF NOT EXISTS operational\.operational_request_nonces/);
