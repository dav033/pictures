 ...
 * `scripts/test/test-plan-editar-python.ts` already covers for the HTTP route
 ...
 * queries PostgreSQL.
 *
 * Run: npx tsx --conditions=react-server scripts/test/test-ajustar-plan-decoracion.ts
 */
