 ...
 * `process.exit(1)` si algo falla) que `scripts/test/test-scene-contracts.ts` y
 * `scripts/test/test-scene-invariants.ts`.
 */
...
// ---------------------------------------------------------------------------
// Mini test runner casero (mismo estilo que scripts/test/test-scene-invariants.ts)
// ---------------------------------------------------------------------------
