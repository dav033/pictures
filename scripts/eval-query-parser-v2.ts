...
const cases: Case[] = [
  ...
  { id: "size-62", phrase: "Globos mini", expected: { diametros_pulgadas: [5] } },
  { id: "size-63", phrase: "Globos medianos", expected: { diametros_pulgadas: [12] } },
  { id: "size-64", phrase: "Globos grandes", expected: { diametros_pulgadas: [18] } },
  { id: "size-65", phrase: "Globos jumbo", expected: { diametros_pulgadas: [24] } },
...
const taxonomyChecks: TaxonomyCheck[] = [
  ...
  { id: "tx-06", phrase: "corazón o redondo", field: "formas", status: "ambiguous", values: ["corazon", "redondo"] },
